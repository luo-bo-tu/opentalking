...
function validateAudioProviderConfigBeforeStart({
  ...
  // STT 校验已跳过 — 萝卜没有百炼 dashscope key，mock 模式下不强制要求 STT
  // 后续需要真实语音输入时再启用这段
  if (false && sttProviderNeedsApiKey(sttProvider) && (sttKeySet !== true || ((sttProvider === "openai_compatible" || sttProvider === "xiaomi_mimo") && sttServiceUrlSet !== true))) {
