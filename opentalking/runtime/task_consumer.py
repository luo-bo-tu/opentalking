...
def _create_runner(
    ...
    return SessionRunner(
        ...
        llm_api_key=settings.llm_api_key,
        llm_model=settings.llm_model,
        llm_openclaw_gateway_url=settings.llm_openclaw_gateway_url,
        llm_openclaw_gateway_token=settings.llm_openclaw_gateway_token,
        llm_openclaw_agent_id=settings.llm_openclaw_agent_id,
        llm_openclaw_task_prompt_template=settings.llm_openclaw_task_prompt_template,
        llm_openclaw_model=settings.llm_openclaw_model,
        llm_openclaw_run_timeout_seconds=settings.llm_openclaw_run_timeout_seconds,
        llm_openclaw_poll_interval_seconds=settings.llm_openclaw_poll_interval_seconds,
        llm_openclaw_request_timeout_seconds=settings.llm_openclaw_request_timeout_seconds,
        llm_openclaw_thinking=settings.llm_openclaw_thinking,
        llm_openclaw_context=settings.llm_openclaw_context,
