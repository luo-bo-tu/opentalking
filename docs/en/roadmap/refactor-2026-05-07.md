...
!!! abstract "TL;DR"
    2026-05-07 implementation plan for reorganizing OpenTalking into the target architecture from the [Architecture Review](../design/architecture-review.md): delete in-repo local-inference code, restructure into `opentalking/{core,providers,media,avatar,voice,pipeline,runtime}`, route all synthesis through OmniRT, and ship a one-click deploy path.

!!! note "Archived snapshot"
    This is the original plan as written on 2026-05-07. Many steps may already be complete; check git history for current state.
...
**Reference:** [docs/architecture-review.md](../design/architecture-review.md) — read § 二 (decisions), § 三 (target layout), § 七 (config→runtime flow), § 八 (Week 1 deliverables) before starting.
...
[architecture-review.md](../design/architecture-review.md).
```
...
详细设计见 [docs/architecture-review.md](https://github.com/datascale-ai/opentalking/blob/main/docs/architecture-review.md)。
...
[CONTRIBUTING.md](https://github.com/datascale-ai/opentalking/blob/main/CONTRIBUTING.md) · [CODE_OF_CONDUCT.md](https://github.com/datascale-ai/opentalking/blob/main/CODE_OF_CONDUCT.md)

## 📄 License

[Apache 2.0](https://github.com/datascale-ai/opentalking/blob/main/LICENSE)
```
